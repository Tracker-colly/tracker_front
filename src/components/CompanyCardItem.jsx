 ...
 * @param {{
 * onClick:()=>void
 * onOptionClick:(type: "Submit"|"Link")
 * }} props 
 * @returns 
 */
export default function CompanyCardItem(props) {
    const {
        index = 0,
        image = "",
        title = "회사명",
    ...
    return <div className={"admin-card-item" + (isAnim ? " view-anim" : "")} onClick={cardClick}>
        <img className="thmb" src={image} alt="" />
        <div className="card-info">
            ...
            <div className="btn-group mt-4">
                <div className="btn-item">
                    <CardOptionBtn img={images.submit_w} title="Submit" onClick={() => {
                        optionClick("Submit")
                    }} />
                </div>

                <div className="btn-item">
                    <CardOptionBtn img={images.link_w} title="Link" onClick={() => {
                        optionClick("Link")
                    }} />
                </div>
            </div>
